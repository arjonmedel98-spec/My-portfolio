...
/* ---------- Featured project screenshot carousel + lightbox ---------- */
(function initFeatureGallery() {
  ...
  const zoomBtn = document.getElementById('featureGalleryZoom');
  ...
  if (lightboxPrev) lightboxPrev.addEventListener('click', () => showInLightbox(current - 1));
  if (lightboxNext) lightboxNext.addEventListener('click', () => showInLightbox(current + 1));
  if (lightbox) {
